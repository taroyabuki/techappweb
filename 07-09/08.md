...
> [!TIP]
> 以下で実行するSQLは[mydb.sql](mydb.sql)にまとめてある。SQLite3で使う場合は，<br>`mkdir /var/data; sqlite3 /var/data/mydb.db < /var/www/techappweb/07-09/mydb.sql`<br>MySQLで使う場合は<br>`mysql -uroot mydb < /var/www/techappweb/07-09/mydb.sql`
...
- [SQLite](app/html/search-sqlite.php)
- [MySQL](app/html/search-mysql.php)
- [共通部分](app/html/search.php)
...
- [SQLite](app/html/order-sqlite.php)
- [MySQL](app/html/order-mysql.php)
- [共通部分](app/html/order.php)
...
- [SQLite](app/html/order-safe-sqlite.php)
- [MySQL](app/html/order-safe-mysql.php)
- [共通部分](app/html/order-safe.php)
