...
この問題は，[hello.php](html/hello.html)の代わりに[hello-safe.php](html/hello-safe.php)を使うと解決される。被害者が同様のURL，http://localhost/hello-safe.php?name=%3Cscript%3Ealert%28document.cookie%29%3B%3C%2Fscript%3E にアクセスしても，クッキーは盗まれない。
