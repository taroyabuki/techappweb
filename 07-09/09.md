...
2. 被害者が，Blog-Aのhttp://127.0.0.1/csrf.html に，同じブラウザでアクセスすると，ユーザ名が書き換えられてしまう。
3. 被害者が，SNS-Bのhttp://localhost/session.php に，同じブラウザでアクセスすると，「Hello, YABUKI.」ではなく，「Hello, ABC.」と表示される。
